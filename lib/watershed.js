...
// Watershed
function Watershed ({ keepalive = true, keepaliveInterval = 5000 } = {}) {
 ...
 */
Watershed.prototype.accept = function accept (req, socket, head, detached, protocols) {
 ...
 */
WatershedConnection.prototype.getProtocol = function getProtocol () {
  return this._proto;
};
